...
public class dashmainadapter2  extends RecyclerView.Adapter<dashmainadapter2.viewholder1>{
    ...
    public dashmainadapter2(ArrayList<base_dashboard> list, Context context)
    {
        this.list=list;
    ...
    public viewholder1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View inflator=LayoutInflater.from(context).inflate(R.layout.offer_item, parent,
                false);
    ...
    public static class viewholder1 extends RecyclerView.ViewHolder
    {
        ...
        public viewholder1(@NonNull View itemView) {
            super(itemView);
            category1=(ImageButton)itemView.findViewById(R.id.offer1);
            category2=(ImageButton)itemView.findViewById(R.id.offer2);
            category_name1=(TextView)itemView.findViewById(R.id.offer_name1);
            category_name2=(TextView)itemView.findViewById(R.id.offer_name2);
            blank_catch=(LinearLayout)itemView.findViewById(R.id.blank_offer_catch);
        }
    }
}
